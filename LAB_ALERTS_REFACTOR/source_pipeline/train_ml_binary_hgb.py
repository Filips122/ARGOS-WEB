...
def main() -> None:
    ...
    root = artifacts_root("offline_LAB_ALERTS_binary_hgb", args.split_mode, now_run_id(), dataset=args.dataset, datasets_base=args.datasets_base, run_config={"sample_frac": args.sample_frac, "epochs": args.epochs, "datasets_base": args.datasets_base})
